    ...
    if ("undefined" != typeof $.fn.daterangepicker) {
        ...
        var a = function (a, b, c) {
            ...
            ranges: {
                ...
                "Últimos Mês": [moment().subtract(1, "mês").startOf("mês"), moment().subtract(1, "mês").endOf("mês")]
            },
            opens: "left",
        ...
        $("#reportrange span").html(moment().subtract(29, "days").format("DD/MM/YYYY") + " - " + moment().format("DD/MM/YYYY")), $("#reportrange").daterangepicker(b, a), $("#reportrange").on("show.daterangepicker", function () {
    ...
    if ("undefined" != typeof $.fn.daterangepicker) {
        ...
        var a = function (a, b, c) {
            ...
            ranges: {
                ...
                "Last Mês": [moment().subtract(1, "month").startOf("month"), moment().subtract(1, "month").endOf("month")]
            },
            opens: "right",
            buttonClasses: ["btn btn-default"],
            applyClass: "btn-small btn-primary",
        ...
        $("#reportrange_right span").html(moment().subtract(29, "days").format("DD/MM/YYYY") + " - " + moment().format("DD/MM/YYYY")), $("#reportrange_right").daterangepicker(b, a), $("#reportrange_right").on("show.daterangepicker", function () {
            console.log("show event fired")

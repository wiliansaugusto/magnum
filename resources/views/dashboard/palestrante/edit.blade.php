                    ...
                    <div class="x_content">
                        <div class="col-md-2 col-sm-2  profile_left">
                            ...
                            <div class="col-md-12 col-sm-12 text-center mt-2">
                                <input id="ds_foto" type="file" class="form-control form-control-sm inputFoto"
                                ...
                                <div class="tab-content p-2" id="nav-tabContent">
                                        ...
                                        <div class="form-group row d-flex justify-content-center">
                                            <div class="col-md-12">
                                                ...
                                                <input id="nm_palestrante" type="text"
                                                    class="form-control form-control-sm " name="nm_palestrante"
                                                    value="{{$data->nm_palestrante }}" autofocus />
                                            </div>
                                        </div>
                                        <div class="form-group row d-flex justify-content-center">
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group row d-flex justify-content-center">
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input
                                                        class="form-check-input  {{ $errors->has('ds_ativo') ? 'is-invalid' : '' }}"
                                                        type="radio" name="ds_ativo" id="ds_disponivel2" value="n"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input
                                                        class="form-check-input {{ $errors->has('ds_visivel_site') ? 'is-invalid' : '' }}"
                                                        type="radio" name="ds_visivel_site" id="ds_visivel_site2"
                                                        value="n"
                                        ...
                                        <div class="form-group row d-flex justify-content-center">
                                            <div class="col-md-12">
                                                ...
                                                <select id="categorias" name="categorias[]"
                                                    ...
                                                    <option value="cat-{{$categoria->id}}" selected="selected">
                                                    ...
                                                    <option value="sub-{{$subCategoria->id}}" selected="selected">
                                                        ...
                                                        <tr id="{{$contato->id}}">
                                                            ...
                                                            <td class='text-right'>
                                                                <button id='excluirContato-{{$contato->id}}'
                                                                    ...
                                                                    data-id="{{$contato->id}}" data-toggle='modal'
                                    ...
                                    <div class="tab-pane fade" id="nav-contrato" role="tabpanel"
                                        ...
                                        <div class="form-group row d-flex justify-content-center">
                                            ...
                                            <div class="col-md-4">
                                                <label for="insc_estadual">Inscrição Estadua*</label>
                                    ...
                                    <div class="tab-pane fade" id="nav-assessor" role="tabpanel"
                                        ...
                                        <div class="form-group row d-flex justify-content-center">
                                            <div class="col-md-2">
                                                <div class="form-check form-check-inline">
                                                    <button type="button" class="btn btn-primary btn-sm"
                                                        data-toggle="modal" data-target="#frmAssessorModal">
                                                        ...
                                                        <tr id="assessor-{{$assessor->id}}">
                                                            ...
                                                            <td class='text-right'>
                                                                <button id='excluirAssessor' type='button'
                                                                    class='btn btn-danger btn-sm'
                                                                    data-id="{{$assessor->id}}" data-toggle='modal'
                                                ...
                                                <table class="table table-sm table-striped" id="tblDescricao">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr id="chamada">
                                                            ...
                                                            <td class='text-right'>
                                                                <button id='excluirDescricao' type='button'
                                                                    class='btn btn-danger btn-sm' data-tipo="chamada"
                                                                    data-toggle='modal'
                                                        ...
                                                        <tr id="curriculo">
                                                            ...
                                                            <td class='text-right'>
                                                                <button id='excluirDescricao' type='button'
                                                                    class='btn btn-danger btn-sm' data-tipo="curriculo"
                                                                    data-toggle='modal'
                                                                    data-target='#frmRemoverDescricaoModal'>
                                                                    <i class='fa fa-trash'></i>
                                                                </button>
                                                        ...
                                                        <tr id="curriculoTec">
                                                            ...
                                                            <td class='text-right'>
                                                                <button id='excluirDescricao' type='button'
                                                                    class='btn btn-danger btn-sm'
                                                                    data-tipo="curriculoTec" data-toggle='modal'
                                                                    data-target='#frmRemoverDescricaoModal'>
                                                                    <i class='fa fa-trash'></i>
                                                                </button>
                                                            </td>
                                                        ...
                                                        <tr id="obs">
                                                            ...
                                                            <td class='text-right'>
                                                                <button id='excluirDescricao' type='button'
                                                                    class='btn btn-danger btn-sm' data-tipo="obs"
                                                                    data-toggle='modal'
                                                                    data-target='#frmRemoverDescricaoModal'>
                                                                    <i class='fa fa-trash'></i>
                                                                </button>
                                                        ...
                                                        <tr id="investimento">
                                                            ...
                                                            <td class='text-right'>
                                                                <button id='excluirDescricao' type='button'
                                                                    class='btn btn-danger btn-sm'
                                                                    data-tipo="investimento" data-toggle='modal'
                                                                    data-target='#frmRemoverDescricaoModal'>
                                                                    <i class='fa fa-trash'></i>
                                                                </button>
                                                            </td>
                                                        ...
                                                        <tr id="pgto">
                                                            ...
                                                            <td class='text-right'>
                                                                <button id='excluirDescricao' type='button'
                                                                    class='btn btn-danger btn-sm' data-tipo="pgto"
                                                                    data-toggle='modal'
                                                                    data-target='#frmRemoverDescricaoModal'>
                                                                    <i class='fa fa-trash'></i>
                                                                </button>
                                                        ...
                                                        <tr id="equipamento">
                                                            ...
                                                            <td class='text-right'>
                                                                <button id='excluirDescricao' type='button'
                                                                    class='btn btn-danger btn-sm'
                                                                    data-tipo="equipamento" data-toggle='modal'
                                                                    data-target='#frmRemoverDescricaoModal'>
                                                                    <i class='fa fa-trash'></i>
                                                                </button>
                                                            </td>
                                    ...
                                    <div class="tab-pane fade" id="nav-video" role="tabpanel"
                                        ...
                                        <div class="form-group row d-flex justify-content-center">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input id="ds_url_video" type="text"
                                                    class="form-control form-control-sm {{ $errors->has('ds_url_video') ? 'is-invalid' : '' }}"
                                                    name="ds_url_video" value="{{ old('ds_url_video') }}" />
                                                @if ($errors->has('ds_url_video'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('ds_url_video') }}</strong>
                                                </span>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea id="ds_descricao_video" type="text"
                                                    class="form-control form-control-sm" name="ds_descricao_video"

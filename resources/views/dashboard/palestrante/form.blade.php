                            ...
                            <div class="col-md-12 col-sm-12">
                                <div id="crop-avatar">
                                    <img id="imgFoto" class="img-responsive avatar-view"
                                        src="{{asset('img/no-image.png')}}" alt="Avatar" title="Change the avatar"
                                        style="width: 100%">
                                </div>
                            </div>
                                        ...
                                        <div class="form-group row d-flex justify-content-center">
                                            <div class="col-md-12">
                                                ...
                                                <input id="nm_palestrante" type="text"
                                                    ...
                                                    value="{{$data->nm_palestrante}}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row d-flex justify-content-center">
                                            <div class="col-md-6">
                                                ...
                                                <select id="ds_nacionalidade" name="ds_nacionalidade"
                                                    ...
                                                    <option class="form-control form-control-sm"
                                                        {{ old('ds_nacionalidade') == '' ? 'selected' : ''}} disabled>

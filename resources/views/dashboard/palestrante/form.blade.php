                                                    ...
                                                    @if (sizeof($data->assessores) > 0)
                                                        @foreach($data->assessores as $assessor)
                                                            ...
                                                            <div class="panel"
                                                                ...
                                                                <div id="collapseAssessor-{{$assessor->id}}"
                                                                     class="panel-collapse collapse in"
                                                                     role="tabpanel"
                                                                     aria-labelledby="heading-{{$assessor->id}}">
                                                                    <div class="panel-body p-3">
                                                                        <table id="assessor-contato-null"
                                                                               class="table table-sm table-striped">
                                                                            <thead>
                                                                            <tr>
                                                    ...
                                                    || $data->ds_equipe_necessario != NULL)
                                                        ...
                                                        @if($data->ds_curriculo != NULL)
                                                            <tr id="curriculo">
                                                                ...
                                                                <td class='text-truncate'>{{ strip_tags($data->ds_curriculo) }}</td>
                                                                <td class='text-right'>
                                                                    <button id='excluirDescricao'
                                                                            type='button'
                                                                            class='btn btn-danger btn-sm'
                                                        ...
                                                        @if($data->ds_curriculo_tecnico != NULL)
                                                            <tr id="curriculoTec">
                                                                ...
                                                                <td class='text-truncate'>{{ strip_tags($data->ds_curriculo_tecnico) }}
                                                                </td>
                                                                <td class='text-right'>
                                                                    <button id='excluirDescricao'
                                                                            type='button'
                                                        ...
                                                        @if($data->ds_observacao != NULL)
                                                            <tr id="obs">
                                                                <td>Observações</td>
                                                                <td class='text-truncate'>{{ strip_tags($data->ds_observacao) }}</td>
                                                                <td class='text-right'>
                                                                    <button id='excluirDescricao'
                                                                            type='button'
                                                                            class='btn btn-danger btn-sm'

...
class DescricaoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        }elseif ($request->all()['tipo_descricao']=="equipamento"){
            $descricao = Palestrante::find($request->id_palestrante);
            $descricao->ds_equipe_necessario = $request->descricao;
            $descricao->save();
            $descricao = Palestrante::find($request->id_palestrante);
            $retorno = array(
                'descricao'=> $descricao->ds_equipe_necessario,
                'tipo_descricao' => $request->tipo_descricao
            );
        }elseif($request->all()['tipo_descricao']=="pgto"){
            $descricao = Palestrante::find($request->id_palestrante);
            $descricao->ds_forma_pagamento = $request->descricao;
            $descricao->save();
            $descricao = Palestrante::find($request->id_palestrante);
            $retorno = array(
                'descricao'=> $descricao->ds_forma_pagamento,
                'tipo_descricao' => $request->tipo_descricao
            );
        }elseif ($request->all()['tipo_descricao']=="investimento"){
            $descricao = Palestrante::find($request->id_palestrante);
            $descricao->ds_investimento = $request->descricao;
            $descricao->save();
            $descricao = Palestrante::find($request->id_palestrante);
            $retorno = array(
                'descricao'=> $descricao->ds_investimento,
                'tipo_descricao' => $request->tipo_descricao
            );
